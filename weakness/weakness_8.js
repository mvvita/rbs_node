...
const verifyCertificateChain = (
	...
	// PROPUST 8
	// Ova provera stvara propust. Ukoliko je sertifikat opozvan nakon prve provere, nece se izvrsiti potrebne provere da to potvrde.
	if (!!cached_certs[hostName]) {
